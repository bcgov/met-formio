...
export var CHECKBOXES_VC = 'checkboxesvc';
...
var Component = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        this.loading = true;
                        url = "".concat(localStorage.getItem('apiurl'));
    ...
    Component.prototype.loadVcs = function (vcs) {
        var valueComponents = vcs.map(function (vc) {
            return {
                label: vc.title,
                value: vc.id,
                icon: vc.icon,
        ...
        this.component.values = __spreadArray([], valueComponents, true);
        this.redraw();
    };
    ...
    Component.prototype.render = function () {
        ...
        return this.grandparentRender(this.renderTemplate('valuecomponent', {
