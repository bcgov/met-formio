export default [
    {
        ...
        placeholder: 'e.g., Rank the following priorities',
    ...
    },
    {
        ...
        tooltip: 'The description is text that will appear below the ranking grid. You can use this text to add instructions.',
        editor: 'ace',
        as: 'html',
        wysiwyg: {
            minLines: 3,
