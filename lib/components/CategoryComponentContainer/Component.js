        ...
        return ParentComponent.schema.apply(ParentComponent, __spreadArray([{
                ...
                components: [
                                ...
                                actions: [
                                    {
                                        ...
                                        type: 'customAction',
                                        customAction: "const change = result[0]\nif(change && change.component.key === '".concat(CATEGORY_CHECKBOXES, "')") +
                                            " {\n  const filteredCategoryComponents = change.component.values.filter(cc => change.value[cc.value] && cc.value !== '".concat(OTHER, "')\n") +
                    ...
                    },
                    {
                        ...
                        customConditional: "show = data && data['".concat(CATEGORY_CHECKBOXES, "'] && data['").concat(CATEGORY_CHECKBOXES, "']['").concat(OTHER, "']"),
                        type: 'categorytextarea',
                        rows: 3,
                        wysiwyg: false,
                        editor: '',
                                ...
                                actions: [
                                    {
                                        ...
                                        type: 'customAction',
                                        customAction: "const change = result[0]\nif(change && change.component.key === '".concat(CATEGORY_CHECKBOXES, "')") +
                                            " {\n  const filteredCategoryComponents = change.component.values.filter(cc => cc.value === '".concat(OTHER, "')\n") +
                                            '  instance.categoryComponents = [...filteredCategoryComponents]\n  instance.redraw()\n}',
                                    },
                                ],
                            },
