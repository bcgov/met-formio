...
var CheckMatrix = /** @class */ (function (_super) {
    ...
    CheckMatrix.prototype.renderCell = function (row, col) {
        return this.renderTemplate('input', {
            input: {
                type: 'input',
                ref: "".concat(this.component.key, "-").concat(row),
                attr: {
                    id: "".concat(this.component.key, "-").concat(row, "-").concat(col),
                    class: 'form-control',
                    type: 'checkbox',
                }
            }
    ...
    CheckMatrix.prototype.attach = function (element) {
        ...
        for (var i = 0; i < this.component.numRows; i++) {
            refs["".concat(this.component.key, "-").concat(i)] = 'multiple';
        }
        this.loadRefs(element, refs);
        this.checks = [];
        for (var i = 0; i < this.component.numRows; i++) {
            this.checks[i] = Array.prototype.slice.call(this.refs["".concat(this.component.key, "-").concat(i)], 0);
